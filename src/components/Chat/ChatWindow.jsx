...
const ChatWindow = ({ chatId, chatTitle }) => {
  ...
  return (
    <div className="flex-1 flex flex-col relative min-h-0">
      ...
      {/* Messages Container - FIXED: Now takes remaining space but leaves room for MessageInput */}
      <div 
        ...
        style={{ maxHeight: 'calc(100vh - 200px)' }} // Reserve space for header and input
      >
        {messages.length === 0 ? (
      ...
      {showScrollToBottom && (
        <button
          ...
          className="absolute bottom-4 right-6 w-10 h-10 bg-blue-500 hover:bg-blue-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center group z-10"
